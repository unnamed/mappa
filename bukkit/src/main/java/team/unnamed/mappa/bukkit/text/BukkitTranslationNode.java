...
public enum BukkitTranslationNode implements TextDefault {
    ...
    TOOL_CHUNK_NAME("bukkit.tool",
        "&6Chunk tool"),
    TOOL_SCAN_NAME("bukkit.tool",
        "&6Scanner tool"),
    TOOL_SCAN_LORE_SCHEME("bukkit.tool",
        "&7Scheme: &6{scheme}"),
    TOOL_SCAN_LORE_PATH("bukkit.tool",
        "&7Path: &6{path}"),
    TOOL_SCAN_LORE_RADIUS("bukkit.tool",
        "&7Radius: &6{radius}"),
